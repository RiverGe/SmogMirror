...
unsigned int smog_set_poweron[9] ={0xAA, 0x01, 0x00, 0x00, 0x00, 0x00, 0x01, 0x66, 0xBB};
unsigned int smog_set_read[9]    ={0xAA, 0x02, 0x00, 0x00, 0x00, 0x00, 0x01, 0x67, 0xBB};
unsigned int smog_set_poweroff[9]={0xAA, 0x03, 0x00, 0x00, 0x00, 0x00, 0x01, 0x68, 0xBB};
...
{ 
  ...
  myGLCD.print("Smog Mirror V1.1 ", LEFT, 65, display_rot);    
...
void SmogSetPowron () {
   for (int i=0; i<9; i++){
     Serial.write ( smog_set_poweron[i]);
     delay(10);
   }
}
void SmogSetPowroff () {
   for (int i=0; i<9; i++){
     Serial.write ( smog_set_poweroff[i]);
     delay(10);
   }
}
...
void Displaylabel(){
    ...
    myGLCD.print("Smog Mirror V1.1 ", LEFT, 0, display_rot);    
